...
int main() {
    ...
    //cout << "m3[2][3]"<<m3[2][2]<< endl;							 // min() returns the minimal value in the matrix.
	//if (min(m1) < min(m3))
	...
	m2(0, 0) = 13;
        cout << "m2[0][0] = "<<m2[0][0]<<endl << "m2[1][0] = "<<m2[1][0]<< endl; // Should print "13 4"
